...
# The repeated silencing of flake8's line-length complaints are unfortunately
# somewhat unavoidable given the length of the password validator class names.
